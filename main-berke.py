...
north_wumponia = [[.40], [.35], [.25]]
subject_values = [[100,0,0],
                  [50,50,0],
                  [50,0,50],
                  [50,0,50],
                  [0,100,0],
...
cpd_OBT = TabularCPD("OBT", 4, values=blood_type_chart)
cpd_KX = TabularCPD("KX", 9, values=subject_values)
cpd_KY = TabularCPD("KY", 9, values=subject_values)
cpd_KBT = TabularCPD("KBT", 4, values=blood_type_chart)
cpd_IX = TabularCPD("IX", 3, values=north_wumponia)
cpd_IY = TabularCPD("IY", 3, values=north_wumponia)
cpd_IBT = TabularCPD("IBT", 4, values=blood_type_chart)
